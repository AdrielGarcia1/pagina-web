    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+54 9 2625459367</p>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="">
                            ...
                            <div>
                                <button class="btn btn-primary btn-block border-0 py-3" type="">Subscribe Now</button>
                            </div>
                        </form>
                    </div>
                </div>
